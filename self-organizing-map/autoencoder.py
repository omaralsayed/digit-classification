...
class Autoencoder:
    def __init__(self, layers, neurons, epoch=0, epochs=5000, learning_rate=0.2, min_learning_rate=0.0025, momentum=0.9):
    ...
    def backward_pass(self, y_train, output):
        ...
        for x in range(self.layers, 1, -1): # 0 changed to 1 to not update input layer's weights (to rely on SOM weights)
